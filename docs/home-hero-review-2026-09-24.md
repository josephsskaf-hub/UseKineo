...
**COMPOSIÇÃO APROVADA EM SEGUIDA PELO FUNDADOR:** principal quadrado, menor e à esquerda, com mais espaço para os três cards verticais. Implementação final: largura e altura do principal compartilham 360–430px no desktop; restante da largura é repartido igualmente entre os secundários. No celular, principal quadrado acima de três cards 9:16. Texto principal adaptado ao quadrado (22–28px), laterais discretos. Esta decisão substitui a altura fixa de 360px da proposta imediatamente anterior.

## Cards sem texto e novo raio — 24/09/2026

**DECISÃO DO USUÁRIO NESTA TAREFA / IMPLEMENTADO:** após aprovar a composição, pediu o raio novo e nenhum texto nos cards. A home usa agora o mesmo raio azul do Explore; removidos nomes de motores, títulos, Watch preview, indicadores de rotação e gradiente de texto dos cards da home. Mantidos nomes acessíveis, clique para abrir o player, pausa global e a geometria aprovada. Examples conserva sua apresentação.

**EVIDÊNCIA DE PRODUÇÃO (Supabase, SELECT restrito ao fundador e aos filmes selecionados, 24/09/2026):** recuperadas as URLs das cenas originais sem legendas de sete filmes em cinematic_submission_claim. Nenhum dado de cliente publicado, nenhuma escrita em banco, nenhuma geração paga. O arquivo antigo do rapaz Kling 3 contém legendas gravadas; não foi encontrada sua origem limpa nas consultas limitadas. Preferência perguntada ao fundador; para cumprir o pedido de cards sem textos, ele foi provisoriamente omitido, sem substituir por filme não escolhido. Playlists resultantes: 2/1/2/2.

**FATO CONFIRMADO — arquivos em public/previews/home-clean-sep24:** robô combina cena de pé (4–7s) com colisão (1–4s); Tunguska usa globo (0–4,5s); Lituya combina baía (0–6s) e queda de rochas (0–4s); vulcão (1–6s), castelo (0,5–6,5s), faroleiro (0–5s), mulher do trem (3–9s). Saída H.264 CRF16/preset slow, 1080×1920, sem áudio, capas WebP95. Fontes nativas: vulcão e trem 1080×1920; Omni/Seedance 720×1280; H3 768×1344. As fontes menores são ampliadas com Lanczos; saída 1080p não significa geração nativa em 1080p. Sem recorte adicional para apagar legendas ou reconstrução de rostos. Paths novos evitam cache dos previews anteriores.

**ARTEFATO VISUAL:** HOME-LIMPA-ANTES-DEPOIS.html, no diretório de outputs desta tarefa, compara a composição aprovada anterior e os cards limpos, incluindo o raio, em desktop e celular.
