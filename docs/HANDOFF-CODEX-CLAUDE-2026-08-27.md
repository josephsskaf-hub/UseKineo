...
**ESTADO ATUAL:** **IMPLEMENTADO / TESTADO LOCALMENTE / AGUARDANDO PUBLICAÇÃO E AMOSTRA EXTERNA.** Nenhum evento, CTA, checkout, pagamento ou render foi forçado para fabricar prova.
