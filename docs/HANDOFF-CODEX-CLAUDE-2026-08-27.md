...
**ESTADO PRÉ-PUSH:** **IMPLEMENTADO / TESTADO LOCALMENTE / AUDITADO COM GO / AINDA NÃO VALIDADO EM PRODUÇÃO.** Após o deploy, validar SHA, build, página pública e ausência de erros; não forçar render para fabricar amostra. A próxima decisão comercial só ocorre depois do gate externo.
