...
**COMPARAÇÃO VISUAL / PREVIEW READY:** `docs/previews/FREE-FINISHED-SCRIPT-BRIDGE-2026-08-31.html` contém antes/depois desktop e mobile, autocontido e sem dependência externa. O deploy Vercel `dpl_AhwCgso7a48Rzgnh5MaMppvHPXEa`, SHA funcional `9ff4aa353e0d9421db58823c7e9121d1e2bae6b1`, chegou a `READY`; build errors-only registrou apenas `Build Completed`. No Chrome do fundador, o card apareceu em desktop e 390px, com largura de documento igual à viewport, sem overflow. O clique abriu o anchor exato, exibiu `What are you starting with?` e a opção `I have a finished script`, com zero console error. Nenhum formulário foi submetido.
