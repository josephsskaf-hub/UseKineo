...
**NÃO TOCADO / COORDENAÇÃO:** preço, desconto, cupom, crédito, validade, trial, SKU, oferta, promessa comercial, launcher de checkout, Stripe server/webhook/métodos, Supabase schema/dados, render, motor, cena, voz, legenda, admin, e-mail, outreach, anúncio ou comunicação externa. A publicação está liberada pela auditoria, mas esta seção permanece **NÃO VALIDADA EM PRODUÇÃO** até o deploy e o smoke da ponta remota.
