...
**IMPLEMENTADO NA BRANCH CODEX, NÃO EM MAIN:** o commit funcional `4e1e042ba535f1ae1c2761a895c78107c1e176dc` monta o `AgencyVolumeBridge` somente quando `params.engine === 'kineo-1'`, depois da tabela técnica e antes de “How it works”. A nova entrada allow-listed `kineo1_engine` mantém o destino, os packs, a promessa e a atribuição canônicos; nenhum UTM substitui a origem original.
