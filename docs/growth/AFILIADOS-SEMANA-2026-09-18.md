...
## R1 — publicação e ressalva do CI (18/09, verificação às 05:33:58 UTC)

**EVIDÊNCIA DE PRODUÇÃO / PUBLICADO:** bd21d589712bef0e77c9a63ff4dce5c201d0643b entrou na main pela fila e batch guardado, remoto confirmado. Vercel dpl_2WDdEdRR4a3hmg1S128Pi3WC25jy READY, target production, alias www.usekineo.com e githubCommitSha exato, conferidos via get_deployment em 18/09 05:33:58 UTC. O deploy está confirmado; comportamento da corrida continua provado só offline. AF-SEMANA-R1 agora está acessível no Git, sem confirmação de leitura pelo Claude. Não reaplicar o candidato 66fe0a6d.

**CONTRADIÇÃO / CI NÃO VERDE:** GitHub Actions run 35311117405 falhou em `Vitrine premium — filtros, movimento, posters e SSR em três idiomas`. A base 1c24c07b, run 35309113596, já falhava nesse mesmo passo. Reexecução local de scripts/test-showcase-premium.mjs:55 reproduziu `founder screenshot opens cinematic_veo`; script, selectors, helpers, componentes e assets envolvidos permanecem idênticos à base por diff. Os passos anteriores (typecheck, sharing, five, locale, home-curation) passaram no CI; os posteriores foram SKIPPED, não aprovados. Não confundir deploy READY com CI verde. A regra antiga de abertura da vitrine precisa ser reconciliada com a curadoria aprovada de 16/09, sem reverter vídeos ou afrouxar o teste às cegas. Pedido BOARD-CI-VITRINE-R1 no diário compartilhado; nenhum código da home alterado por esta entrega.
