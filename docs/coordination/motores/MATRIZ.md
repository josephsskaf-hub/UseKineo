...
| Seedance 2.5 | R6: 5d8d695b com 288/288 + tsc; ledger host e interrupção antes do piso FECHADOS no servidor; CORRIGIR consumidor da recusa na tela | Não executada | Retry genérico ignora retryable:false e renova ID; integrar saída explícita/edição e preservar referências. Mesma claim released é terminal, não reabre. Somente interno |
