...
- EVERY visual_prompt SHOWS ITS OWN VOICEOVER LINE (KINEO-FALA-X-IMAGEM-2026-09-16): the shot depicts the concrete subject, place, era, action and object that scene's voiceover talks about, so a viewer with the sound off still understands the line. Cinematic means camera and light ON the thing being said — never a different thing. Never add props, brands, eras, luxury/vintage/office objects or settings the voiceover does not imply (a line about today's job market is NOT an antique ink pot or a typewriter; a line about a car crashing through a door shows the car crashing through the door, not the aftermath).
