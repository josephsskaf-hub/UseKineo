...
export const metadata: Metadata = {
  ...
  description:
    `Generate images with six AI engines in one place: FLUX Schnell & Dev, Seedream, Grok, Recraft and Nano Banana Pro. Edit with instructions, upscale to HD. Free to start: 10 credits, no card.`,
...
const FAQS = [
  ...
  },
  {
    ...
    a: `Images cost 1–5 credits depending on the engine. Every new account starts free with 10 credits — enough to try every image engine. Paid plans start at ` + STARTER_MONTH + ' for ' + STARTER_CREDITS + ' credits, charged in USD worldwide, and credits are shared across images, voice and video.',
  },
  {
