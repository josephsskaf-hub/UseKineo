...
export const metadata: Metadata = {
  ...
  description:
    `Turn text into natural speech with four AI voice engines: MiniMax Speech HD, ElevenLabs v3, Dia and Kokoro. From 1 credit per 1,000 characters. Use any voice in your videos. Free to start: 10 credits, no card.`,
      ...
      <main style={{ maxWidth: 860, margin: '0 auto', padding: '72px 20px 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: 14, marginBottom: 44 }}>
          {[
            ...
            ['💸 From 1 credit / 1k chars', `A full 60-second narration costs 1–2 credits. Your 80 trial credits cover a dozen takes or more.`],
