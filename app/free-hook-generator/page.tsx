...
export const metadata: Metadata = {
  ...
  description:
    'Generate 5 scroll-stopping hooks for your next YouTube Short or TikTok free with AI — no signup. Type a topic, get viral opening lines instantly, then turn one into a finished video, usually in 3–7 minutes.',
  alternates: { canonical: 'https://www.usekineo.com/free-hook-generator' },
  openGraph: {
    title: 'Free AI Viral Hook Generator — No Signup',
    description: 'Type a topic, get 5 viral hooks for your Short instantly. Then make the full video, usually in 3–7 minutes.',
