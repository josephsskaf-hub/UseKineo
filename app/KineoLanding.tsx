    ...
    <main className="klp">
      ...
      <section id="pricing">
        <div className="wrap">
          ...
          <div className="snote">Try it first: <b>{ft(OFFER, 'create, watch, download and share up to 3 Fast videos every 24h', 'every new account can start a 7-day Creator trial — $1 to start, 80 credits, every engine except Studio')}</b>{ft(OFFER, ' — no card, watermark included.', ' — no card.')}</div>
