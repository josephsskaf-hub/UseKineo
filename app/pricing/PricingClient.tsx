  ...
  return [
    {
      ...
      videosPerMonth: `≈ ${Math.floor(TIER_CREDITS.starter / 20)} engine films / month`,
    ...
    },
    {
      ...
      videosPerMonth: `≈ ${Math.floor(TIER_CREDITS.basic / 20)} engine films / month`,
    ...
    },
    {
      ...
      videosPerMonth: `≈ ${Math.floor(TIER_CREDITS.pro / 20)} films / month`,
