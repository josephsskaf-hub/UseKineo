  ...
  return [
    {
      ...
      outcome: 'Post every day. Stock footage, AI voice, no watermark.',
      videosPerMonth: '25 videos a month',
    ...
    },
    {
      ...
      outcome: 'Every scene generated by AI, not stock footage.',
      videosPerMonth: '7 AI videos a month',
      cta: { label: 'Get Started', href: '#checkout' },
      highlight: true,
      popular: true,
    },
    {
      ...
      outcome: 'Cinema-quality motion at 1080p, our best engine.',
      videosPerMonth: '10 AI videos a month',
      cta: { label: 'Get Started', href: '#checkout' },
    },
  ]
}
