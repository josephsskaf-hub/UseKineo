  ...
  return [
    {
      ...
      // por mês eu consigo postar". Máx 4 bullets, zero emoji (checkmark único
      // no render), letra miúda fora do card.
      outcome: 'One Short a day, every day.',
      videosPerMonth: '25 videos / month',
      features: [
        'Watermark-free downloads',
        'Stock footage matched to every scene',
        'AI script, voiceover and captions',
        'One AI-generated video included',
      ],
    ...
    },
    {
      ...
      outcome: 'Every scene generated by AI — not stock.',
      videosPerMonth: '7 AI videos / month',
      features: [
        'Every scene generated by AI (Seedance)',
        'One Hollywood film included every month',
        'AI Presenter — talking avatars, perfect lip-sync',
    ...
    },
    {
      ...
      outcome: 'Cinema quality, 1080p.',
      videosPerMonth: '10 AI videos / month',
      features: [
        'Kling 2.5 engine at 1080p — our best motion',
        'Priority render queue + premium voices',
        'Character Lock, gesture clips and UGC ads',
          ...
          {buildPricing(resolvedCurrency).map((p) => {
            ...
            return (
              ...
              >
                ...
                {/* KINEO-PRICING-CLARITY-2026-08-03 — uma linha de posicionamento
                    (o que este degrau MUDA), acima do preço. */}
                {'outcome' in p && p.outcome ? (
                  <div className="mt-1.5 text-[13px] font-bold leading-snug text-[#f5f5f7]">
                    {p.outcome}
                  </div>
                ) : null}
                ...
                {billing === 'monthly' && (p.tier === 'starter' || p.tier === 'basic') && (
                  <div className="mt-2">
                    ...
                    {/* KINEO-PRICING-CLARITY-2026-08-03 — a renovação e o grant
                        do 1º mês saíram DO CARD (densidade) mas continuam na
                        página, numa linha única abaixo da grade. A divulgação do
                        crédito do intro é proteção contra chargeback e não pode
                        sumir — só mudou de lugar. */}
                ...
                {/* KINEO-PRICING-CLARITY-2026-08-03 — VÍDEOS/MÊS é o 2º elemento
                    mais visível da página, logo abaixo do preço: é a unidade em
                    que o comprador pensa. O tagline denso de créditos saiu; a
                    mecânica de crédito vive na tabela comparativa. */}
                {'videosPerMonth' in p && p.videosPerMonth ? (
                  <div className="mt-3 text-[15px] font-black tracking-tight text-[#2997ff]">
                    {p.videosPerMonth}
                  </div>
                ) : null}
                ...
                {isPaid && (
                  <p className="mt-2 text-center text-[12px] font-semibold text-[#86868b]">
                    Secure Stripe checkout · billed by Kineo
                  </p>
                )}
              </div>
            )
