...
export const metadata: Metadata = {
  ...
  description:
    `${ft(OFFER, 'Create up to 3 watermarked Fast videos every 24h with no card.', OFFER.copy.headline)} Paid plans start at ${STARTER_MONTH} (USD reference). Customers in Brazil normally pay in BRL; check the checkout for the amount. Paid plans unlock clean, watermark-free MP4 exports.`,
