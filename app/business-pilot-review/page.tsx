...
const CSS = `
.bpr-page{min-height:100vh;background:radial-gradient(circle at 85% 0,rgba(41,151,255,.17),transparent 34%),#05070b;color:#f5f7fb;font-family:var(--font-sans),Arial,sans-serif}
