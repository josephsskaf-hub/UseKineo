// KINEO-ADMIN-HQ-2026-08-03 — this is the OLD /admin server overview
// (Push #482), moved verbatim from app/admin/page.tsx to /admin/overview so
// the consolidated Admin HQ could take over the /admin root. Linked from the
// HQ footer as "old overview".
