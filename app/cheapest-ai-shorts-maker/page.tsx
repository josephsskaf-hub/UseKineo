...
const STEPS: { n: string; t: string; d: string }[] = [
  ...
  { n: '2', t: 'Pick the right-cost visual engine', d: 'Fast Mode costs 5 credits per video. AI Generated uses 20 credits for original Seedance scenes, while Cinematic uses 50 credits for premium Kling scenes.' },
...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: 'Do I have to use the most expensive AI engine?', a: 'No. You pick the engine per video. Fast Mode uses 5 credits with matched stock footage, AI Generated uses 20 credits for Seedance scenes, and Cinematic uses 50 credits for premium Kling scenes.' },
