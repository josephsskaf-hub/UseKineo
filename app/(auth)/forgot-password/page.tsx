        ...
        <div className="rounded-2xl p-8" style={{ background: 'var(--card)', border: '1px solid var(--border)', boxShadow: '0 0 80px color-mix(in srgb, var(--indigo) 8%, transparent)' }}>
          {sent ? (
            <div className="text-center py-4">
              ...
              <Link href={loginHref} className="inline-flex items-center gap-2 text-sm font-semibold" style={{ color: 'var(--accent)', textDecoration: 'none' }}>
                ← Back to Sign In
              </Link>
            </div>
          ) : (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div>
                  ...
                  <input
                    ...
                    style={{ background: 'var(--card2)', border: '1px solid var(--border2)', color: 'var(--text)', fontFamily: 'inherit' }}
                ...
                {error && (
                  <div id="forgot-error" role="alert" className="rounded-xl px-4 py-3 text-sm" style={{ background: 'color-mix(in srgb, var(--danger) 8%, transparent)', border: '1px solid color-mix(in srgb, var(--danger) 20%, transparent)', color: 'var(--danger)' }}>
                    {error}
                  </div>
                )}
                ...
                <button
                  ...
                  style={{ background: 'var(--indigo)', color: 'var(--on-accent)', boxShadow: '0 4px 22px color-mix(in srgb, var(--indigo) 30%, transparent)', opacity: loading ? 0.7 : 1, cursor: loading ? 'not-allowed' : 'pointer' }}
                >
