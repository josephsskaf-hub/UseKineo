...
export default function PartnersPage() {
  const faq = [
    ...
    { q: 'Can I test Kineo first?', a: 'Yes. Every new account starts free with 10 credits and every engine unlocked, no card. If you need extra demo access for a specific audience or tutorial, email us and we will sort it out with you.' },
