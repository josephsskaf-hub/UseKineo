    ...
    <div className="px-4 sm:px-6 py-7 pb-20 max-w-6xl mx-auto">
      ...
      <header className="mb-9">
        ...
        <h1
          ...
          style={{ fontSize: 'clamp(1.75rem, 4vw, 2.25rem)', color: '#f5f5f7', lineHeight: 1.08 }}
        >
          Start from a{' '}
          <span
            style={{
        ...
        <p style={{ fontSize: '0.85rem', color: '#86868b', lineHeight: 1.65, maxWidth: 520 }}>
        ...
        >
          {[
            ...
            <div
              ...
              style={{
                borderLeft: i > 0 ? '1px solid #2a2a2d' : 'none',
              }}
            >
              <span
              ...
              <span style={{ fontSize: '0.68rem', color: '#86868b', marginTop: 2 }}>{s.label}</span>
            </div>
          ))}
        </div>
      </header>
          ...
          return (
            <div
              ...
              style={{
                ...
                border: isHovered
                  ...
                  : '1px solid #2a2a2d',
                boxShadow: isHovered
                  ? `0 12px 48px ${t.accent}1f, 0 2px 0 ${t.accent}14 inset`
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div
                  ...
                  style={{
                    ...
                    boxShadow: isHovered ? `0 0 22px ${t.accent}30` : 'none',
                  }}
                >
                  {t.emoji}
                </div>
              ...
              <p
                ...
                style={{ color: '#86868b', lineHeight: 1.6, fontSize: '0.82rem' }}
              >
                {t.description}
              </p>
              ...
              <button
                ...
                className="tmpl-btn rounded-[980px] py-2.5 text-sm font-black mt-auto"
                style={{
                  background: '#f5f5f7',
                  color: '#000',
                  border: 'none',
      ...
      <p
        ...
        style={{ fontSize: '0.75rem', color: '#86868b', opacity: 0.55 }}
      >
        New templates added regularly · Suggest one at{' '}
        <span style={{ color: '#2997ff' }}>support@usekineo.com</span>
      </p>
    </div>
  )
}
