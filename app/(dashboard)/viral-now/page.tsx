...
const DESCRIPTION =
  'Browse 8 ready-to-create YouTube Shorts ideas, rotated every 4 hours from Kineo’s curated library. Pick one and keep it through signup — free to start, no card.'
