...
console.log('== (d) claim guarda a image_url real por cena; a retomada aceita a cena ==')
{
  ...
  const b = rr.indexOf('\n}\n', a) + 3
  const SS = roda('export ' + rr.slice(a, b), { KLING3_I2V_MODEL: 'fal-ai/kling-video/o3/pro/image-to-video', H3_I2V_MODEL: 'minimax/h3/image-to-video', OMNI_I2V_MODEL: 'google/gemini-omni-flash/image-to-video', S25_I2V_MODEL: 'fal-ai/seedance-2.5/image-to-video', normalizeAspect: (r) => (['9:16', '16:9', '1:1', '4:5'].includes(r) ? r : '9:16') /* LOTE2-RESGATE-FIEL-2026-09-23: signedScene passou a levar o formato do claim */ })
