...
equal(quickstart.CHATGPT_QUICKSTART_VARIANT, 'chatgpt_quickstart_v1', 'variant is stable')
...
ok(banner.includes('What did ChatGPT give you?'), 'banner asks the branching question')
