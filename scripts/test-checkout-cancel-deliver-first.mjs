...
ok(page.includes('Make my included Seedance film →'), 'primary CTA names the included outcome')
...
ok(trialPolicy.includes("TRIAL_FIRST_DELIVERY_VERSION = 'trial_first_seedance_60s_v1'"), 'destination version is pinned by the shared policy')
