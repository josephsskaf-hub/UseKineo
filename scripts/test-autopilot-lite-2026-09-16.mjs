...
checa('webhook: as 3 cadeias de tier reconhecem autopilot_lite (1ª compra, troca, renovação) + a 4ª do razão (KINEO-RAZAO-ASSINANTE-2026-09-17: firstPaymentCreditsFromSession grava credits_granted no payment_success)', (wh.match(/=== 'autopilot_lite' \? 'autopilot_lite'/g) || []).length === 3 && /function firstPaymentCreditsFromSession\([\s\S]{0,600}=== 'autopilot_lite' \? 'autopilot_lite'/.test(wh) && wh.includes("currentSubscription.metadata?.tier === 'autopilot_lite'"))
