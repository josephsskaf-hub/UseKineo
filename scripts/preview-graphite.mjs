...
pages.push(['Credits','components/CreditsTopupModal.tsx',{amount:150,currency:'usd',credits:0},{onClose(){},surface:'offline_preview'}])
...
const docs=rendered.map(({name,html})=>({name,variants:[true,false].map(before=>{
 ...
 if(before&&name==='Credits')content=renderPage('components/CreditsTopupModal.tsx',true,{amount:150,currency:'usd',credits:0},{onClose(){},surface:'offline_preview'},base)
