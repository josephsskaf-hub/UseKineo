...
equal(policy.CHECKOUT_RESUME_CHOICE_VERSION, 'resume_own_film_v2', 'commercial choice version identifies owner-film proof')
...
equal(metadata.resume_choice_version, 'resume_own_film_v2', 'metadata joins the commercial variant')
...
check(marker.includes('resume_own_film_v2:basic:monthly:usd:open_session'), 'marker carries variant and offer identity')
