...
checa('Creator mensal custa 1900 (planos de 08/09)', /basic:\s*\{\s*usd:\s*1900\s*\}/.test(cp))
checa('copy da porta fala $1, 7 days, 80 credits e $15', ['$1', '7 days', '80 credits', '$19'].every((t) => P.CARD_ENTRY_COPY.sentence.includes(t) || P.CARD_ENTRY_COPY.headline.includes(t)))
