...
const run = async () => {
  ...
  checa('v4/R12: com teto da cena, aceita até o teto (27 para 12 s) e a rota pede alvo+3 até teto + 2', E.fitsVoiceoverTarget(27, 23, 27) && !E.fitsVoiceoverTarget(28, 23, 27) && /targetWords: Math\.min\(Math\.max\(x\.target \+ 3, Math\.ceil\(x\.target \* 1\.2\)\), x\.maxWords \+ 2\), maxWords: x\.maxWords \+ 2/.test(rd('app/api/generate-video-cinematic/route.ts'))) // 15/09 R12
