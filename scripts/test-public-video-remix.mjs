...
const freeScriptHandoff = source('lib/growth/freeScriptSignupHandoff.ts')
...
ok(tool.includes("fromPublicVideo ? 'public_video' : 'seo'"), 'public-video origin maps to its signup source')
ok(freeScriptHandoff.includes('utm_source: attribution.source'), 'signup builder carries the selected source')
