...
check('29 eventos, únicos, todos com prefixo ads_', ev.ADS_EVENTS.length === 29 && new Set(ev.ADS_EVENTS).size === 29 && ev.ADS_EVENTS.every((n) => n.startsWith('ads_')))
...
// Reancorado com motivo (revisão 24/09 noite): apelido josephsskaf+x@gmail.com deixou de ser conta da casa (o cadastro confirma
// e-mail sozinho; qualquer um registraria um apelido novo) e a conta da casa decide ANTES do plano (senão o fundador, plano pro,
// caía em 'subscriber' e o interruptor desligado o barrava no próprio canário).
check('conta interna só pela lista exata; apelidos, test%, mailinator e sufixo forjado NÃO; a conta da casa decide antes do plano', ['josephsskaf@gmail.com', 'JosephSkaf@hotmail.com'].every((e) => R(null, e, agora) === 'internal') && ['josephsskaf+ads1@gmail.com', 'test123@gmail.com', 'qualquer@mailinator.com', 'josephsskaf+x@gmail.com.evil.io', 'xjosephsskaf+x@gmail.com', '', null].every((e) => R(null, e, agora) === 'none') && R({ plan: 'pro' }, 'josephsskaf@gmail.com', agora) === 'internal')
