...
checa('submittedPrompt: toda cena abre com "No one talks on camera" (prefixo de silêncio da rota) e leva o mouthSuffix', enviados.every((p) => p.startsWith('No one talks on camera.') && p.includes('mouth closed, not speaking, no lip movement, no talking.')))
