...
chk('custo por segundo registrado ($0.462/s — 150cr seria prejuizo)', rt.includes('S25_USD_PER_SECOND = 0.462'))
...
chk('preco 250 espelhado (etiqueta provisoria, martelo do fundador pendente)', rc.includes('S25_CREDIT_COST = 250') && ler('lib/credits/engineCost.ts').includes("case 'cinematic_s25':"))
