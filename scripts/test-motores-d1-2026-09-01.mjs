...
chk('pricing / schema / calculadora atras do interruptor', ler('app/pricing/PricingClient.tsx').includes('S25_PUBLIC ?') && ler('components/StructuredData.tsx').includes('VIDEO_ENGINE_COUNT_WORD') && ler('app/cheapest-ai-shorts-maker/ShortCostCalculator.tsx').includes('S25_PUBLIC ?'))
