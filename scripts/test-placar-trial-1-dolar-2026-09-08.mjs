...
checa('painel Versão B no /admin/overview (por pessoa, hoje e 7 dias)', /title="Versão B — porta de \$1"/.test(page) && /export function funilVersaoB\(/.test(rd('lib/admin/versaoBFunnel.ts')))
