...
// guarda os preços V7 ($14/$29/$59). Se a fonte religar, o preâmbulo deixa de disparar e as verificações voltam.
...
checa('llms.txt: filmes por plano CALCULADOS (videosPerMonth por motor/60 s), nada digitado', /videosPerMonth\('pro', 'cinematic_h3'\)/.test(ll) && /videosPerMonth\('basic', 'cinematic_ai'\)/.test(ll) && !/8 MiniMax H3|about 12 Seedance, 8/.test(ll))
