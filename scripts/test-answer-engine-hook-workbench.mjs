...
equal(redirect.pathname, '/generate', 'existing generate handoff is preserved')
...
check((client.match(/source: hookCtaEventSource\(entry\)/g) ?? []).length === 3, 'all three CTA callers preserve the isolated event taxonomy')
