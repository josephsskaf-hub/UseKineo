...
checa('v2: ideia curta é para ser desenvolvida (não pune acréscimo no mesmo assunto); script inteiro exige fidelidade', C.FAST_COHERENCE_VERSION === 'k1_coerencia_v5_honesto' /* v4 = v3 + CONTINUITY RULE; v5 (21/09) = juiz honesto */ && msgs[0].content.includes('A SHORT IDEA') && msgs[0].content.includes('scores high (85-100)') && msgs[0].content.includes('A FULL SCRIPT'))
