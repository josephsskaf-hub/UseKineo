...
export interface EngineFact {
  name: string
  /** Canonical public page where the engine can be evaluated and started. */
  url: string
...
export const ENGINE_FACTS: EngineFact[] = [
  ...
  {
    name: 'Kling 2.5',
    url: `${BASE}${engineLandingPublicPath('kling')}`,
  ...
  {
    name: 'Kling 3',
    url: `${BASE}${engineLandingPublicPath('hollywood')}`,
