...
export const ADS_MODELS: readonly AdsModel[] = [
  ...
  },
  {
    ...
    note: 'Photos only: every frame is yours. Cheapest ad to produce and, for local direct response, images often beat video.',
  },
  {
    id: 'problema_solucao',
    ...
    beats: [
      { seconds: 4, screen: 'Your own photo of the PAIN (the leak, the before, the messy desk) with a 4-5 word question card', speech: '[Pain] again?', media: 'stock' },
      { seconds: 8, screen: 'Two of your photos or clips making it worse: consequence, time lost, cost', speech: 'Every day it drags on, [consequence]. Fixing it yourself usually costs more.', media: 'stock' },
    ...
    note: 'Every frame is your own media: for the pain part, pick a photo that shows the problem (the before, the mess); the solution must be your real work.',
  },
  {
  ...
  },
  {
    ...
    beats: [
      { seconds: 5, screen: 'Card "3 mistakes that cost you money with [topic]" over your strongest photo', speech: 'Three mistakes that make you lose money with [topic].', media: 'stock' },
      { seconds: 16, screen: 'Large "1." over one of your photos that shows the mistake', speech: 'Mistake one: [mistake]. [Consequence in one sentence].', media: 'stock' },
      { seconds: 15, screen: 'Large "2." over another of your photos', speech: 'Mistake two: [mistake]. [Consequence].', media: 'stock' },
    ...
    note: 'Educational tone; the format that works for regulated professions. Every frame is your own media: office, team or work photos, 4 or more so the same picture does not repeat.',
  },
  {
    id: 'contagem_prazo',
