...
// ~4.0 words/second, NOT the ~2.5 wps the old ranges assumed.
// Push #295 — RE-RECALIBRATED for tts-1-hd. Push #292 upgraded the model from
// tts-1 → tts-1-hd, which speaks at ~3.1 wps (not 4.0 wps). The ranges were
// never updated, so scripts had ~29% too many words → audio ran long → a "45s"
// video came out ~1:06. New ranges = old ranges × (3.1 / 4.0) ≈ 0.775, rounded.
//   30s → 85–100 words and 4 scenes
//   45s → 130–150 words and 5 scenes (default)
