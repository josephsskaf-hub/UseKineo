...
export const HOME_FEATURED_PLAYLISTS: WallVideo[][] = [
  [robot, selectedFilm('90bd8367-60c6-4811-8fdd-3a5b0200eec6')],
  [selectedFilm(HOME_FILM_IDS[1]), hoodie],
  [selectedFilm(HOME_FILM_IDS[2]), selectedFilm('b5434412-62b9-48f5-9a10-c36e2e725c9f', 'lighthouse-scene', '50% 28%')],
