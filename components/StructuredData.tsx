...
const softwareApplicationSchema = {
  ...
  featureList: [
    ...
    `${VIDEO_ENGINE_COUNT_WORD} AI video engines in one account: ${VIDEO_ENGINE_LIST_COPY}. ${PAUSED_ENGINES_COPY}`,
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: `${VIDEO_ENGINE_COUNT_WORD}, behind one interface and one balance: ${VIDEO_ENGINE_LIST_COPY}. ${PAUSED_ENGINES_COPY} You choose the engine per video, so a cheap explainer and a cinematic flagship can come out of the same account on the same day. Every clip on the Kineo homepage is a real render from the engine named on the card — the badge always tells the truth about which model made it.`,
      },
    },
    {
      '@type': 'Question',
